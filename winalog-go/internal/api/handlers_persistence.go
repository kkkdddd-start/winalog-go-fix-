...
func NewPersistenceHandler(db *storage.DB) *PersistenceHandler {
	...
	defaultRuleConfigs := map[string]PersistenceRuleInfo{
		...
		"com_hijack_detector": {Name: "com_hijack_detector", Description: "COM Hijacking", Technique: "T1546.015", Category: "COM", Enabled: true, EventIDs: []int32{4670}, Patterns: []string{"HKEY_CURRENT_USER\\Software\\Classes\\"}, Whitelist: []string{}, BuiltinWhitelist: []string{
			...
			"%ProgramFiles%\\Windows NT\\TableTextService",
			"%PROGRAMFILES%\\Windows Media Player",
			"%PROGRAMFILES%\\Windows Photo Viewer",
			"%PROGRAMFILES%\\Windows Defender",
			"%PROGRAMFILES%\\Windows NT\\TableTextService",
			"%ProgramData%\\CrossDevice",
			"%UserProfile%\\AppData\\Local\\Kingsoft",
			"%UserProfile%\\AppData\\Local\\Programs\\XMind",
			"%UserProfile%\\AppData\\Local\\Microsoft\\TeamsMeetingAdd-in",
			"D:\\Program Files (x86)\\360\\360zip",
			...
			"PhotoAcq.dll", "PhotoViewer.dll", "mpvis.dll", "wmpnssui.dll", "wmpnssci.dll",
			"WMPMediaSharing.dll", "MpProvider.dll", "AMMonitoringProvider.dll",
			"TableTextService.dll", "acppage.dll", "rdpcorets.dll",
			"XMindShellExt.dll", "360ZipExt64.dll", "CrossDevice.Streaming.Source.dll",
			"msado15.dll", "msadrh15.dll", "mapi32.dll",
			"kdesktopshellext64.dll", "kwpsshellext64.dll", "qingnse64.dll", "qingshellext64.dll",
